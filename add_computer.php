...
<div class="dashboard-wrapper">
    <div class="container-fluid dashboard-content">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Add computer</h2>
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Add computer</li>
        ...
        $sql_cl = "SHOW COLUMNS FROM  `$database`.`computer`";
                                            ...
                                            <Table class="table table-striped table-bordered first">
                                                <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <input type="submit" name="submit" value="Add computer" class="btn btn-warning" onclick="return confirm('คุณต้องการแก้ไขข้อมูลจริงๆใชมั้ย ?')" />
                                                    </td>
                                                </tr>
                    ...
                    <div class="col-xl- col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header bg-warning text-center p-3">
                                <h4 class="mb-0 text-white">Add computer detail</h4>
                            </div>
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($detail)) {
        ...
        $sql_insert = "INSERT INTO `$database`.`computer`";
        $column ="";
        $value ="";
        for ($x = 0; $x <= sizeof($stack) - 1; $x++) {
       ...
       // $sql_update = $sql_update . " WHERE id = '$id_rec'";
        ...
        if ($res == true) {
            ...
            $_SESSION['update'] = "<div class = 'success'>Add computer Successfully.</div>";
            audit_t($OperatorName, $OperatorID, "position= $id", "Add computer", "Add Process", "$detail add process $process", $ECN_No,$get_database);
            echo '<script type="text/javascript">';
            echo ' alert("add computer complete")';  //not showing an alert box.
            echo '</script>';
        ...
        echo '<script type="text/javascript">';
        echo ' alert("ต้องใส่เหตุผลในการ add computer ด้วย")';  //not showing an alert box.
        echo '</script>';
    }
}
