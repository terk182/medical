...
<div class="dashboard-wrapper">
    <div class="container-fluid dashboard-content">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Add <?php echo $table; ?></h2>

                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="process_data.php?db=<?php echo $database; ?>&process=<?php echo $table; ?>" class="breadcrumb-link"><?php echo $table; ?></a></li>
                                
                                <li class="breadcrumb-item active" aria-current="page">Add <?php echo $table; ?></li>
        ...
        if ($table == "station") 
        {
            ...
            $sql = "SELECT process_id FROM $table ORDER BY id DESC LIMIT 1";
                                            ...
                                            <Table class="table table-striped table-bordered first">
                                                <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <input type="submit" name="submit" value="Add <?php echo $table; ?>" class="btn btn-warning" onclick="return confirm('คุณต้องการแก้ไขข้อมูลจริงๆใชมั้ย ?')" />
                                                    </td>
                                                </tr>
                                                ...
                                                for ($x = 0; $x <= sizeof($stack) - 1; $x++) {
                                                    ...
                                                    }elseif($stack[$x] == 'process_id'){

                                                        if ($table == "station") 
                                                        {
                                                        echo '<input type="text" name="' . $stack[$x] . '" value="'.$last.'">';
                                                        }
                                                        else
                                                        {
                    ...
                    <div class="col-xl- col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header bg-warning text-center p-3">
                                <h4 class="mb-0 text-white">Add <?php echo $table; ?> detail</h4>
                            </div>
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($detail)) {
        ...
        $sql_insert = "INSERT INTO `$database`.`$table`";
        $column = "";
        $value = "";
        for ($x = 0; $x <= sizeof($stack) - 1; $x++) {
        ...
        if ($res == true) {
            ...
            $_SESSION['update'] = "<div class = 'success'>Add $table Successfully.</div>";
            audit_t($OperatorName, $OperatorID, "position= $id", "Add Value In databaes", "Add In $table", "$detail in $process", $ECN_No,$database);
            echo '<script type="text/javascript">';
            echo ' alert("add ' . $table . ' complete")';  //not showing an alert box.
            echo '</script>';
        ...
        echo '<script type="text/javascript">';
        echo ' alert("ต้องใส่เหตุผลในการ add ' . $table . ' ด้วย")';  //not showing an alert box.
        echo '</script>';
    }
}
