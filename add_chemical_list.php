...
<div class="dashboard-wrapper">
    <div class="container-fluid dashboard-content">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Add chemical_list</li>
        ...
        $sql_cl = "SHOW COLUMNS FROM  `$database`.`chemical_list`";
                                            ...
                                            <Table class="table table-striped table-bordered first">
                                                <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <input type="submit" name="submit" value="Add chemical_list" class="btn btn-warning" onclick="return confirm('คุณต้องการแก้ไขข้อมูลจริงๆใชมั้ย ?')" />
                                                    </td>
                                                </tr>
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($detail)) {
        ...
        $sql_insert = "INSERT INTO `$database`.`chemical_list`";
        $column ="";
        $value ="";
        for ($x = 0; $x <= sizeof($stack) - 1; $x++) {
       ...
       // $sql_update = $sql_update . " WHERE id = '$id_rec'";
        ...
        echo '<script type="text/javascript">';
        echo ' alert("ต้องใส่เหตุผลในการ add chemical_list ด้วย")';  //not showing an alert box.
        echo '</script>';
    }
}
