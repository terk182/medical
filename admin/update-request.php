...
<?php
    if(isset($_GET['id']))
    {
        ...
        $sql2 = "SELECT * FROM tbl_process WHERE id = $id";
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <table class = "tbl-30">
                    ...
                    <tr>
                        <td>process_name: </td>
                        <td>
                            <input type="text" name="process_name" value="<?php echo $process_name; ?>">
                        </td>
                    </tr>
                        ...
                        <td>
                            <select name="category">
                                ...
                                <?php
                                    ...
                                    {
                                        echo "<option>Category Not Available.</option>";
                                    }
                                ?>
